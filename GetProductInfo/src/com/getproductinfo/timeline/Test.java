...
public class Test {
	...
	public static void main(String s[]) {
		...
		try {
			...
			if (productNotExistInTimeLine) {
				...
				timelineItem.setHtml("<article> <figure>   <img src=\"http://api.qrserver.com/v1/create-qr-code/?data=HelloWorld!&size=300x300\">"
						+ " </figure><section> "
	...
	public void publishOnTimeLine(JSONObject productInfo,String productId,String outletId,String accessToken) {
			...
			if (productNotExistInTimeLine) {
				...
				timelineItem
						.setHtml("<article> <figure>   <img src=\"http://api.qrserver.com/v1/create-qr-code/?data=HelloWorld!&size=300x300\">"
								+ " </figure><section> "
								+ "<table class=\"text-minor no-border\"> <tbody> <tr> <td >"
								+ "Article Number = "+articleNumber+" </br>"
								+ " Manufacturer = "+manufacturer+" </br>"
								+ "Name = "+name+" </br>"
								+ "Availability Store = "+availabilityInStore+" </br>"
								+ "Availability Warehouse = "+availabilityInWareHouse+"</td> </tr> "
								+ "</tbody> </table> </section></article>");
				MirrorClient.insertTimelineItem(credential, timelineItem);
			}
		} catch (IOException e) {
